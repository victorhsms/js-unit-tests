...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    const meuRestaurante = createMenu({ food: {'coxinha': 3.9, 'sopa': 9.9, 'sashimi': 12.3}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    ...
    // ```
    expect(meuRestaurante.fetchMenu()).toMatchObject({ food: {}, drink: {} });
    // ```
    ...
    // ```
    const objetoQualquer = { comida: {}, bebida: {} };
    ...
    expect(meuRestaurante.consumption).toStrictEqual(["coxinha", "agua", "sopa", "sashimi"]);
    // ```
    // Agora faça o TESTE 7 deste arquivo.
    // --------------------------------------------------------------------------------------
    // TESTE 7: Verifique se a função `order` aceita que pedidos repetidos sejam acrescidos a consumption.
    // ```
    const teste7 = ["coxinha", "agua", "coxinha"];
    meuRestaurante.order('coxinha');
    meuRestaurante.order('agua');
    meuRestaurante.order('coxinha');
    // ref: https://jestjs.io/pt-BR/docs/expect#expectarraycontainingarray
    expect(meuRestaurante.consumption).toStrictEqual(expect.arrayContaining(teste7));
    // ```
    ...
    // ```
    expect(meuRestaurante.pay()).toBe(45.87);
    // ```
